...
export function ConfigEditor(props: Props) {
  ...
  const updatePassword = (value: string) => props.onOptionsChange({
    ...props.options,
    secureJsonData: { ...props.options.secureJsonData, password: value },
  });
  const resetPassword = () => props.onOptionsChange({
    ...props.options,
  ...
  return <>
    ...
    {!ssoEnabled ? <>
      <Field label="Doris username"><Input value={data.username ?? ''} onChange={e => update(props, 'username', e.currentTarget.value)} /></Field>
